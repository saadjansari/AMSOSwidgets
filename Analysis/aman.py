...
def parseArgs():
    ...
    parser.add_argument('-T', '--tactoid', action='store_true', default=False, help='use tactoid options for analysis')
    parser.add_argument('-C', '--confine', action='store_true', default=False, help='use confinement options for analysis')
    parser.add_argument('-G', '--graph', action='store_true', default=False, help='make graphs for sims')
    parser.add_argument('--overwrite', action='store_true', default=False, help='overwrite feather files')
...
def analyze(opts):
    ...
    # get sim folders
    spaths1 = glob.glob( os.path.join( relpath, '*/*/result')) # folders that have seed folders
